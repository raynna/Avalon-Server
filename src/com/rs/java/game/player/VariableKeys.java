...
public class VariableKeys {
    ...
    public enum IntKey {
        KILLCOUNT(1, 0), DEATHCOUNT(2, 0), KILLSTREAK(3, 0), KILLSTREAK_RECORD(4, 0), PK_POINTS(5, 0), EP(6, 0),

        HIGHEST_ATTACK_LEVEL(20, 1), HIGHEST_STRENGTH_LEVEL(21, 1), HIGHEST_DEFENCE_LEVEL(22, 1), HIGHEST_RANGED_LEVEL(23, 1), HIGHEST_PRAYER_LEVEL(24, 1), HIGHEST_MAGIC_LEVEL(25, 1),
    ...
    public enum BooleanKey {
        ...
        BANK_PIN(1, false),
        TALKED_TO_MR_EX(2, false),
        TALKED_TO_MARV(3, false),
        TALKED_TO_GILES(4, false),
        TALKED_TO_ESTOCADA(5, false),
        DISRUPTION_ACTIVE(6, false),
        VENGEANCE_ACTIVE(7, false),
        FROZEN(8, false);
        private final int uid;
