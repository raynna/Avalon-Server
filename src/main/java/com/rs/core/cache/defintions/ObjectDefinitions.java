...
public class ObjectDefinitions {
        ...
        if (opcode != 1 && opcode != 5) {
                                                                                ...
                                                                                if (opcode == 71)
                                                                                    ...
                                                                                    if (opcode == 73)
                                                                                        ...
                                                                                        if (opcode != 77
                                                                                            ...
                                                                                            int i_66_ = -1;
                                                                                            if (opcode == 92) {
                                                                                                int tmp92_639 = stream.readUnsignedShort(); i_66_ = tmp92_639 == 65535 ? -1 : (tmp92_639 + com.rs.Settings._639_OBJECTS_OFFSET); //
                                                                                            ...
                                                                                            for (int i_68_ = 0; i_67_ >= i_68_; i_68_++) {
                                                                                                int tmpObj639 = stream.readUnsignedShort(); toObjectIds[i_68_] = tmpObj639 == 65535 ? -1 : (tmpObj639 + com.rs.Settings._639_OBJECTS_OFFSET); //
            ...
            for (int i_74_ = 0; i_74_ < i_73_; i_74_++) {
                ...
                for (int i_76_ = 0; i_75_ > i_76_; i_76_++)
                    modelIds[i_74_][i_76_] = stream.readUnsignedShort() + com.rs.Settings._639_MODEL_OFFSET;
            }
            if (opcode == 5 && !aBoolean1162)
                skipReadModelIds639(stream);
        }
    ...
    private void readValueLoop(InputStream stream) {
        for (; ; ) {
            ...
            if (id >= com.rs.Settings._639_OBJECTS_OFFSET)
