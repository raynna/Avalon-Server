...
import com.rs.java.game.npc.quest.Delrith;
import com.rs.java.game.player.Player;
import com.rs.java.game.player.controllers.Controller;

public final class DelrithController extends Controller {
    ...
    public void sendTarget(int id, WorldTile tile) {
        if (target != null) target.disapear();
