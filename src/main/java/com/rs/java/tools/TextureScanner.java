...
public class TextureScanner {
    ...
    private static final int INDEX = 9; // materials
    private static final Path OUTPUT_DIR = Path.of("dump/texturescam/");

    // sprite we’re searching for
    private static final int TARGET_SPRITE_ID = 20318;
