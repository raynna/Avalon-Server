    ...
    val table = dropTable(
        ...
        preRollDrops {
            ...
            listOf(
                ...
                "item.statius_s_warhammer", "item.zuriel_s_hood", "item.zuriel_s_robe_top", "item.zuriel_s_robe_bottom", "item.zuriel_s_staff",
                "item.morrigan_s_coif", "item.morrigan_s_leather_body", "item.morrigan_s_leather_chaps"
            ).forEach { drop(it, numerator = 1, denominator = 512) }

            listOf(
                "item.corrupt_statius_s_full_helm", "item.corrupt_statius_s_platebody", "item.corrupt_statius_s_platelegs",
                "item.corrupt_vesta_s_chainbody", "item.corrupt_vesta_s_plateskirt", "item.corrupt_vesta_s_longsword", "item.corrupt_vesta_s_spear",
                "item.corrupt_statius_s_warhammer", "item.corrupt_zuriel_s_hood", "item.corrupt_zuriel_s_robe_top", "item.corrupt_zuriel_s_robe_bottom", "item.corrupt_zuriel_s_staff",
                "item.corrupt_morrigan_s_coif", "item.corrupt_morrigan_s_leather_body", "item.corrupt_morrigan_s_leather_chaps"
            ).forEach { drop(it, numerator = 1, denominator = 256) }
        }
