...
object KalphiteQueenDropTable {
    ...
    val table = dropTable(category = MonsterCategory.BOSS, rareDropTable = true,
        rolls = 1) {
        ...
        tertiaryDrops {
            drop("item.dragon_chainbody", numerator = 1, denominator = 128)
            drop("item.dragon_2h_sword", numerator = 1, denominator = 128)
            drop("item.dragon_pickaxe", numerator = 1, denominator = 128)
            drop("item.kq_head", numerator = 1, denominator = 128)
            drop(
