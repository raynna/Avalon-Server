...
object MeleeShop : GameShop {
    override val definition: ShopDefinition = shop {
        ...
        item("item.rune_sq_shield")
        item("item.rune_boots")
        item("item.tokhaar_full_helm")
        item("item.tokhaar_platebody")
        item("item.tokhaar_platelegs")
        item("item.tokhaar_plateskirt")
        item("item.tokhaar_boots")
        item("item.tokhaar_full_helm_g")
        item("item.tokhaar_platebody_g")
        item("item.tokhaar_platelegs_g")
        item("item.tokhaar_plateskirt_g")
        item("item.tokhaar_boots_g")
