...
object GoldenMiningOutfit {
    ...
    private val PIECE_KEYS =
        listOf(
            "item.golden_mining_helmet",
            "item.golden_mining_top",
            "item.golden_mining_trousers",
            "item.golden_mining_gloves",
            "item.golden_mining_boots",
        )
    ...
    fun roll(player: Player) {
        ...
        Msg.collect(player, "You find a piece of the golden mining outfit!")
    }
