...
object ProjectileRegistry {
    ...
    init {
        ...
        register(Projectile.MORRIGAN_THROWING_AXE, ProjectileType(startHeight = 20, endHeight = 36, startTime = 42, arc = 15, displacement = 11))
        ...
        register(Projectile.STANDARD_MAGIC_FAST, ProjectileType(startHeight = 40, endHeight = 36, multiplier = 10, startTime = 21, arc = 11))
        register(Projectile.STANDARD_MAGIC_INSTANT, ProjectileType(startHeight = 40, endHeight = 36, multiplier = 15, startTime = 0, arc = 11))
