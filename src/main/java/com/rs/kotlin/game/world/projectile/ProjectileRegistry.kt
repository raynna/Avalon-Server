...
object ProjectileRegistry {
    ...
    init {
        ...
        register(Projectile.LEECH, ProjectileType(speed = 42, displacement = 100))
        register(Projectile.SOULSPLIT, ProjectileType(startHeight = 0, endHeight = 0, speed = 42, arc = 0))
