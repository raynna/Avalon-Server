package raynna.core.cache.defintions;
...
public class ObjectDefinitions {
    ...
    private void readValues639(InputStream stream, int opcode) {
        ...
        if (opcode != 1 && opcode != 5) {
                            ...
                            if (opcode == 19)
                                ...
                                if (opcode != 23) {
                                    if (opcode != 24) {
                                                                            ...
                                                                            if (opcode == 69)
                                                                                ...
                                                                                if (opcode == 71)
                                                                                    ...
                                                                                    if (opcode == 73)
                                                                                        ...
                                                                                        // 639 format: ignoreOnRoute is a routing-only flag.
                                                                                        // Do NOT set ignoreClipOnAlternativeRoute here — clip() skips
                                                                                        // walls that have that flag, so setting it would make 639 GE
                                                                                        // walls non-solid.  This opcode has no server-side effect.
                                                                                    } else if (opcode != 75) {
                                                                                        if (opcode != 77
                                                                                                && opcode != 92) {
                                                                                            if (opcode == 78) {
                                                                                                                            ...
                                                                                                                            if (opcode == 102)
                                                                                                                                ...
                                                                                                                                if (opcode == 105)
                                                                                                                                    ...
                                                                                                                                    for (int i_56_ = 0; i_56_ < i_55_; i_56_++) {
                                                                                                                                        int anim639 = stream.readUnsignedShort(); animations[i_56_] = anim639 == 65535 ? -1 : anim639; //
                                                                                            ...
                                                                                            int i_66_ = -1;
                                                                                            if (opcode == 92) {
                                                                                                int tmp92_639 = stream.readUnsignedShort(); i_66_ = tmp92_639 == 65535 ? -1 : (tmp92_639 + raynna.app.Settings._639_OBJECTS_OFFSET); //
                                                                                            ...
                                                                                            for (int i_68_ = 0; i_67_ >= i_68_; i_68_++) {
                                                                                                int tmpObj639 = stream.readUnsignedShort(); toObjectIds[i_68_] = tmpObj639 == 65535 ? -1 : (tmpObj639 + raynna.app.Settings._639_OBJECTS_OFFSET); //
                                        ...
                                        int anim639_24 = stream.readUnsignedShort(); objectAnimation = anim639_24 == 65535 ? -1 : anim639_24;
                                    }
                                } else
                                    thirdInt = 1;
                            } else
            ...
            for (int i_74_ = 0; i_74_ < i_73_; i_74_++) {
                ...
                for (int i_76_ = 0; i_75_ > i_76_; i_76_++)
                    modelIds[i_74_][i_76_] = stream.readUnsignedShort() + raynna.app.Settings._639_MODEL_OFFSET;
            }
            if (opcode == 5 && !aBoolean1162)
                skipReadModelIds639(stream);
        }
    ...
    // 639 format: model IDs are always 2-byte unsigned shorts, not BigSmart
    private void skipReadModelIds639(InputStream stream) {
        int length = stream.readUnsignedByte();
        for (int index = 0; index < length; index++) {
            stream.skip(1); // type byte
            stream.skip(stream.readUnsignedByte() * 2); // 2 bytes per model ID
        }
    }
    ...
    private void readValueLoop(InputStream stream) {
        for (; ; ) {
            ...
            if (id >= raynna.app.Settings._639_OBJECTS_OFFSET)
                readValues639(stream, opcode);
            else
