package raynna.core.packets.handlers;
...
import raynna.game.item.itemdegrading.ArmourRepair;
import raynna.game.minigames.castlewars.CastleWars;
import raynna.game.minigames.crucible.Crucible;
import raynna.game.minigames.fightpits.FightPits;
import raynna.game.minigames.pest.Lander;
...
import raynna.game.objects.plugins.DoorsAndGates;
import raynna.game.objects.plugins.GlobalStairs;
...
import raynna.game.player.actions.Charter;
import raynna.game.player.actions.CowMilkingAction;
import raynna.game.player.actions.WaterFilling;
import raynna.game.player.actions.WhirlPool;
import raynna.game.player.actions.combat.Magic;
import raynna.game.player.actions.construction.BoneOffering;
import raynna.game.player.actions.runecrafting.SihponActionNodes;
import raynna.game.player.actions.skills.agility.Agility;
import raynna.game.player.actions.skills.agility.impl.AgilityFalador;
import raynna.game.player.actions.skills.agility.impl.AgilityPyramid;
import raynna.game.player.actions.skills.agility.impl.ApeAtollAgility;
import raynna.game.player.actions.skills.agility.impl.BarbarianOutpostAgility;
import raynna.game.player.actions.skills.agility.impl.GnomeAgility;
import raynna.game.player.actions.skills.agility.impl.WildyAgility;
import raynna.game.player.actions.skills.construction.House;
import raynna.game.player.actions.skills.construction.HouseConstants;
import raynna.game.player.actions.skills.construction.Sawmill;
import raynna.game.player.actions.skills.cooking.Cooking;
import raynna.game.player.actions.skills.cooking.Cooking.Cookables;
import raynna.game.player.actions.skills.firemaking.Bonfire;
import raynna.game.player.actions.skills.mining.EssenceMining;
import raynna.game.player.actions.skills.mining.EssenceMining.EssenceDefinitions;
import raynna.game.player.actions.skills.mining.LavaFlowMine;
import raynna.game.player.actions.skills.mining.MiningBase;
import raynna.game.player.actions.skills.newmining.Mining;
import raynna.game.player.actions.skills.prayer.Burying.Bone;
import raynna.game.player.actions.skills.runecrafting.AbbysObsticals;
import raynna.game.player.actions.skills.runecrafting.CombinationRunes;
import raynna.game.player.actions.skills.runecrafting.CombinationRunes.CombinationRunesStore;
import raynna.game.player.actions.skills.runecrafting.Tiaras;
import raynna.game.player.actions.skills.runecrafting.Tiaras.RunecraftingTiaraStore;
import raynna.game.player.actions.skills.smithing.JewllerySmithing;
import raynna.game.player.actions.skills.smithing.Smelting;
import raynna.game.player.actions.skills.smithing.Smelting.SmeltingBar;
import raynna.game.player.actions.skills.smithing.Smithing.ForgingBar;
import raynna.game.player.actions.skills.smithing.Smithing.ForgingInterface;
...
import raynna.game.player.content.GrotwormLair;
import raynna.game.player.content.ItemConstants;
import raynna.game.player.content.KillScoreBoard;
import raynna.game.player.content.WildernessKills;
import raynna.game.player.content.dungeoneering.rooms.puzzles.FishingFerretRoom;
import raynna.game.player.content.shootingstar.ShootingStarAction;
import raynna.game.player.controllers.Falconry;
import raynna.game.player.controllers.FightCaves;
import raynna.game.player.controllers.RecipeForDisaster;
import raynna.game.player.dialogues.npcs.MiningGuildDwarf;
...
import raynna.game.player.combat.CombatUtils;
...
public final class ObjectHandler {
    ...
    private static void handleOption1(final Player player, final WorldObject object, InputStream stream) {
        ...
        player.setRouteEvent(new RouteEvent(object, () -> {
            ...
            if (area != null && area.onObjectClick(player, object)) {
                return;
            }
            ...
            if (object.getId() == 47237 && player.getY() == 5260) {
                ...
                if (player.getPrayer().getPrayerPoints() < player.getSkills().getRealLevel(Skills.PRAYER) * 10) {
                    player.lock(12);
                    player.animate(new Animation(12563));
                    player.getPrayer()
                            .restorePrayer((int) ((player.getSkills().getRealLevel(Skills.PRAYER) * 10) * 1.15));
            ...
            if (id == 36786)
                ...
                player.setNextForceMovement(
                        new ForceMovement(new WorldTile(x1, 9799, 0), 3, player.getX() == 2886 ? 1 : 3));
                ...
                if (player.getSkills().getRealLevel(Skills.MINING) < 60) {
