package raynna.game.item.itemdegrading;
...
public class ItemDegrade {
	...
	public enum DegradeData {
		...
		AHRIMS_TOP_25(new Item(4871), null, DegradeType.AT_INCOMMING_HIT, new Item(4872), 1000),

		AHRIMS_BOTTOM(new Item(4714), new Item(4874), DegradeType.AT_INCOMMING_HIT, new Item(4878), 1),
		AHRIMS_BOTTOM_100(new Item(4874), new Item(4875), DegradeType.AT_INCOMMING_HIT, new Item(4878), 1000),
		AHRIMS_BOTTOM_75(new Item(4875), new Item(4876), DegradeType.AT_INCOMMING_HIT, new Item(4878), 1000),
		AHRIMS_BOTTOM_50(new Item(4876), new Item(4877), DegradeType.AT_INCOMMING_HIT, new Item(4878), 1000),
		AHRIMS_BOTTOM_25(new Item(4877), null, DegradeType.AT_INCOMMING_HIT, new Item(4878), 1000),

		AHRIMS_STAFF(new Item(4710), new Item(4862), DegradeType.AT_OUTGOING_HIT, new Item(4866), 1),
		AHRIMS_STAFF_100(new Item(4862), new Item(4863), DegradeType.AT_OUTGOING_HIT, new Item(4866), 1000),
		AHRIMS_STAFF_75(new Item(4863), new Item(4864), DegradeType.AT_OUTGOING_HIT, new Item(4866), 1000),
		AHRIMS_STAFF_50(new Item(4864), new Item(4865), DegradeType.AT_OUTGOING_HIT, new Item(4866), 1000),
		AHRIMS_STAFF_25(new Item(4865), null, DegradeType.AT_OUTGOING_HIT, new Item(4866), 1000),

		/**
		 * @Dharoks
		 */

		DHAROKS_HELM(new Item(4716), new Item(4880), DegradeType.AT_INCOMMING_HIT, new Item(4884), 1),
		DHAROKS_HELM_100(new Item(4880), new Item(4881), DegradeType.AT_INCOMMING_HIT, new Item(4884), 1000),
		DHAROKS_HELM_75(new Item(4881), new Item(4882), DegradeType.AT_INCOMMING_HIT, new Item(4884), 1000),
		DHAROKS_HELM_50(new Item(4882), new Item(4883), DegradeType.AT_INCOMMING_HIT, new Item(4884), 1000),
		DHAROKS_HELM_25(new Item(4883), null, DegradeType.AT_INCOMMING_HIT, new Item(4884), 1000),

		DHAROKS_AXE(new Item(4718), new Item(4886), DegradeType.AT_OUTGOING_HIT, new Item(4890), 1),
		DHAROKS_AXE_100(new Item(4886), new Item(4887), DegradeType.AT_OUTGOING_HIT, new Item(4890), 1000),
		DHAROKS_AXE_75(new Item(4887), new Item(4888), DegradeType.AT_OUTGOING_HIT, new Item(4890), 1000),
		DHAROKS_AXE_50(new Item(4888), new Item(4889), DegradeType.AT_OUTGOING_HIT, new Item(4890), 1000),
		DHAROKS_AXE_25(new Item(4889), null, DegradeType.AT_OUTGOING_HIT, new Item(4890), 1000),

		DHAROKS_PLATEBODY(new Item(4720), new Item(4892), DegradeType.AT_INCOMMING_HIT, new Item(4896), 1),
		DHAROKS_PLATEBODY_100(new Item(4892), new Item(4893), DegradeType.AT_INCOMMING_HIT, new Item(4896), 1000),
		DHAROKS_PLATEBODY_75(new Item(4893), new Item(4894), DegradeType.AT_INCOMMING_HIT, new Item(4896), 1000),
		DHAROKS_PLATEBODY_50(new Item(4894), new Item(4895), DegradeType.AT_INCOMMING_HIT, new Item(4896), 1000),
		DHAROKS_PLATEBODY_25(new Item(4895), null, DegradeType.AT_INCOMMING_HIT, new Item(4896), 1000),

		DHAROKS_PLATELEGS(new Item(4722), new Item(4898), DegradeType.AT_INCOMMING_HIT, new Item(4902), 1),
		DHAROKS_PLATELEGS_100(new Item(4898), new Item(4899), DegradeType.AT_INCOMMING_HIT, new Item(4902), 1000),
		DHAROKS_PLATELEGS_75(new Item(4899), new Item(4900), DegradeType.AT_INCOMMING_HIT, new Item(4902), 1000),
		DHAROKS_PLATELEGS_50(new Item(4900), new Item(4901), DegradeType.AT_INCOMMING_HIT, new Item(4902), 1000),
		DHAROKS_PLATELEGS_25(new Item(4901), null, DegradeType.AT_INCOMMING_HIT, new Item(4902), 1000),

		/**
		 * @Guthans
		 */

		GUTHANS_HELM(new Item(4724), new Item(4904), DegradeType.AT_INCOMMING_HIT, new Item(4908), 1),
		GUTHANS_HELM_100(new Item(4904), new Item(4905), DegradeType.AT_INCOMMING_HIT, new Item(4908), 1000),
		GUTHANS_HELM_75(new Item(4905), new Item(4906), DegradeType.AT_INCOMMING_HIT, new Item(4908), 1000),
		GUTHANS_HELM_50(new Item(4906), new Item(4907), DegradeType.AT_INCOMMING_HIT, new Item(4908), 1000),
		GUTHANS_HELM_25(new Item(4907), null, DegradeType.AT_INCOMMING_HIT, new Item(4908), 1000),

		GUTHANS_SPEAR(new Item(4726), new Item(4910), DegradeType.AT_OUTGOING_HIT, new Item(4914), 1),
		GUTHANS_SPEAR_100(new Item(4910), new Item(4911), DegradeType.AT_OUTGOING_HIT, new Item(4914), 1000),
		GUTHANS_SPEAR_75(new Item(4911), new Item(4912), DegradeType.AT_OUTGOING_HIT, new Item(4914), 1000),
		GUTHANS_SPEAR_50(new Item(4912), new Item(4913), DegradeType.AT_OUTGOING_HIT, new Item(4914), 1000),
		GUTHANS_SPEAR_25(new Item(4913), null, DegradeType.AT_OUTGOING_HIT, new Item(4914), 1000),

		GUTHANS_PLATEBODY(new Item(4728), new Item(4916), DegradeType.AT_INCOMMING_HIT, new Item(4920), 1),
		GUTHANS_PLATEBODY_100(new Item(4916), new Item(4917), DegradeType.AT_INCOMMING_HIT, new Item(4920), 1000),
		GUTHANS_PLATEBODY_75(new Item(4917), new Item(4918), DegradeType.AT_INCOMMING_HIT, new Item(4920), 1000),
		GUTHANS_PLATEBODY_50(new Item(4918), new Item(4919), DegradeType.AT_INCOMMING_HIT, new Item(4920), 1000),
		GUTHANS_PLATEBODY_25(new Item(4919), null, DegradeType.AT_INCOMMING_HIT, new Item(4920), 1000),

		GUTHANS_PLATELEGS(new Item(4730), new Item(4922), DegradeType.AT_INCOMMING_HIT, new Item(4926), 1),
		GUTHANS_PLATELEGS_100(new Item(4922), new Item(4923), DegradeType.AT_INCOMMING_HIT, new Item(4926), 1000),
		GUTHANS_PLATELEGS_75(new Item(4923), new Item(4924), DegradeType.AT_INCOMMING_HIT, new Item(4926), 1000),
		GUTHANS_PLATELEGS_50(new Item(4924), new Item(4925), DegradeType.AT_INCOMMING_HIT, new Item(4926), 1000),
		GUTHANS_PLATELEGS_25(new Item(4925), null, DegradeType.AT_INCOMMING_HIT, new Item(4926), 1000),

		/**
		 * @Karils
		 */

		KARILS_COIF(new Item(4732), new Item(4928), DegradeType.AT_INCOMMING_HIT, new Item(4932), 1),
		KARILS_COIF_100(new Item(4928), new Item(4929), DegradeType.AT_INCOMMING_HIT, new Item(4932), 1000),
		KARILS_COIF_75(new Item(4929), new Item(4930), DegradeType.AT_INCOMMING_HIT, new Item(4932), 1000),
		KARILS_COIF_50(new Item(4930), new Item(4931), DegradeType.AT_INCOMMING_HIT, new Item(4932), 1000),
		KARILS_COIF_25(new Item(4931), null, DegradeType.AT_INCOMMING_HIT, new Item(4932), 1000),

		KARILS_CROSSBOW(new Item(4734), new Item(4934), DegradeType.AT_OUTGOING_HIT, new Item(4938), 1),
		KARILS_CROSSBOW_100(new Item(4934), new Item(4935), DegradeType.AT_OUTGOING_HIT, new Item(4938), 1000),
		KARILS_CROSSBOW_75(new Item(4935), new Item(4936), DegradeType.AT_OUTGOING_HIT, new Item(4938), 1000),
		KARILS_CROSSBOW_50(new Item(4936), new Item(4937), DegradeType.AT_OUTGOING_HIT, new Item(4938), 1000),
		KARILS_CROSSBOW_25(new Item(4937), null, DegradeType.AT_OUTGOING_HIT, new Item(4938), 1000),

		KARILS_TOP(new Item(4736), new Item(4940), DegradeType.AT_INCOMMING_HIT, new Item(4944), 1),
		KARILS_TOP_100(new Item(4940), new Item(4941), DegradeType.AT_INCOMMING_HIT, new Item(4944), 1000),
		KARILS_TOP_75(new Item(4941), new Item(4942), DegradeType.AT_INCOMMING_HIT, new Item(4944), 1000),
		KARILS_TOP_50(new Item(4942), new Item(4943), DegradeType.AT_INCOMMING_HIT, new Item(4944), 1000),
		KARILS_TOP_25(new Item(4943), null, DegradeType.AT_INCOMMING_HIT, new Item(4944), 1000),

		KARILS_SKIRT(new Item(4738), new Item(4946), DegradeType.AT_INCOMMING_HIT, new Item(4950), 1),
		KARILS_SKIRT_100(new Item(4946), new Item(4947), DegradeType.AT_INCOMMING_HIT, new Item(4950), 1000),
		KARILS_SKIRT_75(new Item(4947), new Item(4948), DegradeType.AT_INCOMMING_HIT, new Item(4950), 1000),
		KARILS_SKIRT_50(new Item(4948), new Item(4949), DegradeType.AT_INCOMMING_HIT, new Item(4950), 1000),
		KARILS_SKIRT_25(new Item(4949), null, DegradeType.AT_INCOMMING_HIT, new Item(4950), 1000),

		/**
		 * @Torags
		 */

		TORAGS_HELM(new Item(4745), new Item(4952), DegradeType.AT_INCOMMING_HIT, new Item(4956), 1),
		TORAGS_HELM_100(new Item(4952), new Item(4953), DegradeType.AT_INCOMMING_HIT, new Item(4956), 1000),
		TORAGS_HELM_75(new Item(4953), new Item(4954), DegradeType.AT_INCOMMING_HIT, new Item(4956), 1000),
		TORAGS_HELM_50(new Item(4954), new Item(4955), DegradeType.AT_INCOMMING_HIT, new Item(4956), 1000),
		TORAGS_HELM_25(new Item(4955), null, DegradeType.AT_INCOMMING_HIT, new Item(4956), 1000),

		TORAGS_HAMMERS(new Item(4747), new Item(4958), DegradeType.AT_OUTGOING_HIT, new Item(4962), 1),
		TORAGS_HAMMERS_100(new Item(4958), new Item(4959), DegradeType.AT_OUTGOING_HIT, new Item(4962), 1000),
		TORAGS_HAMMERS_75(new Item(4959), new Item(4960), DegradeType.AT_OUTGOING_HIT, new Item(4962), 1000),
		TORAGS_HAMMERS_50(new Item(4960), new Item(4961), DegradeType.AT_OUTGOING_HIT, new Item(4962), 1000),
		TORAGS_HAMMERS_25(new Item(4961), null, DegradeType.AT_OUTGOING_HIT, new Item(4962), 1000),

		TORAGS_PLATEBODY(new Item(4749), new Item(4964), DegradeType.AT_INCOMMING_HIT, new Item(4968), 1),
		TORAGS_PLATEBODY_100(new Item(4964), new Item(4965), DegradeType.AT_INCOMMING_HIT, new Item(4968), 1000),
		TORAGS_PLATEBODY_75(new Item(4965), new Item(4966), DegradeType.AT_INCOMMING_HIT, new Item(4968), 1000),
		TORAGS_PLATEBODY_50(new Item(4966), new Item(4967), DegradeType.AT_INCOMMING_HIT, new Item(4968), 1000),
		TORAGS_PLATEBODY_25(new Item(4967), null, DegradeType.AT_INCOMMING_HIT, new Item(4968), 1000),

		TORAGS_PLATELEGS(new Item(4751), new Item(4970), DegradeType.AT_INCOMMING_HIT, new Item(4974), 1),
		TORAGS_PLATELEGS_100(new Item(4970), new Item(4971), DegradeType.AT_INCOMMING_HIT, new Item(4974), 1000),
		TORAGS_PLATELEGS_75(new Item(4971), new Item(4972), DegradeType.AT_INCOMMING_HIT, new Item(4974), 1000),
		TORAGS_PLATELEGS_50(new Item(4972), new Item(4973), DegradeType.AT_INCOMMING_HIT, new Item(4974), 1000),
		TORAGS_PLATELEGS_25(new Item(4973), null, DegradeType.AT_INCOMMING_HIT, new Item(4974), 1000),

		/**
		 * @Veracs
		 */

		VERACS_HELM(new Item(4753), new Item(4976), DegradeType.AT_INCOMMING_HIT, new Item(4980), 1),
		VERACS_HELM_100(new Item(4976), new Item(4977), DegradeType.AT_INCOMMING_HIT, new Item(4980), 1000),
		VERACS_HELM_75(new Item(4977), new Item(4978), DegradeType.AT_INCOMMING_HIT, new Item(4980), 1000),
		VERACS_HELM_50(new Item(4978), new Item(4979), DegradeType.AT_INCOMMING_HIT, new Item(4980), 1000),
		VERACS_HELM_25(new Item(4979), null, DegradeType.AT_INCOMMING_HIT, new Item(4980), 1000),

		VERACS_FLAIL(new Item(4755), new Item(4982), DegradeType.AT_OUTGOING_HIT, new Item(4986), 1),
		VERACS_FLAIL_100(new Item(4982), new Item(4983), DegradeType.AT_OUTGOING_HIT, new Item(4986), 1000),
		VERACS_FLAIL_75(new Item(4983), new Item(4984), DegradeType.AT_OUTGOING_HIT, new Item(4986), 1000),
		VERACS_FLAIL_50(new Item(4984), new Item(4985), DegradeType.AT_OUTGOING_HIT, new Item(4986), 1000),
		VERACS_FLAIL_25(new Item(4985), null, DegradeType.AT_OUTGOING_HIT, new Item(4986), 1000),

		VERACS_BRASSARD(new Item(4757), new Item(4988), DegradeType.AT_INCOMMING_HIT, new Item(4992), 1),
		VERACS_BRASSARD_100(new Item(4988), new Item(4989), DegradeType.AT_INCOMMING_HIT, new Item(4992), 1000),
		VERACS_BRASSARD_75(new Item(4989), new Item(4990), DegradeType.AT_INCOMMING_HIT, new Item(4992), 1000),
		VERACS_BRASSARD_50(new Item(4990), new Item(4991), DegradeType.AT_INCOMMING_HIT, new Item(4992), 1000),
		VERACS_BRASSARD_25(new Item(4991), null, DegradeType.AT_INCOMMING_HIT, new Item(4992), 1000),

		VERACS_SKIRT(new Item(4759), new Item(4994), DegradeType.AT_INCOMMING_HIT, new Item(4998), 1),
		VERACS_SKIRT_100(new Item(4994), new Item(4995), DegradeType.AT_INCOMMING_HIT, new Item(4998), 1000),
		VERACS_SKIRT_75(new Item(4995), new Item(4996), DegradeType.AT_INCOMMING_HIT, new Item(4998), 1000),
		VERACS_SKIRT_50(new Item(4996), new Item(4997), DegradeType.AT_INCOMMING_HIT, new Item(4998), 1000),
		VERACS_SKIRT_25(new Item(4997), null, DegradeType.AT_INCOMMING_HIT, new Item(4998), 1000),
