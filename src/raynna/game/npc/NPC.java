...
import raynna.game.npc.combat.NPCCombat;
...
import raynna.game.player.actions.skills.prayer.Burying;
    ...
    public void setBonuses() {
        ...
        if (id == 7891 || id == 4474) {
            combatData = new CombatData(
                    ...
                    new raynna.game.npc.combatdata.MeleeDefence(0, 0, 0),
                    new raynna.game.npc.combatdata.MagicDefence(0),
                    new raynna.game.npc.combatdata.RangedDefence(0, 0, 0),
                    new raynna.game.npc.combatdata.Immunities(false, false, false, false, false),
                    new raynna.game.npc.combatdata.Weaknesses(),
                    new raynna.game.npc.combatdata.MaxHit(0, 0, 0, 0),
                    true,
                    List.of("Crush"),
                    4,
                    0,
        ...
        if (levels != null && !levels.isEmpty()) {
            ...
            raynna.game.npc.combatdata.MeleeDefence meleeDef;
            raynna.game.npc.combatdata.MagicDefence magicDef;
            raynna.game.npc.combatdata.RangedDefence rangeDef;

            switch (defs.getAttackStyle()) {

                case MELEE:
                    meleeDef = new raynna.game.npc.combatdata.MeleeDefence(defence * 2, defence * 2, defence * 2);
                    magicDef = new raynna.game.npc.combatdata.MagicDefence(defence / 2);
                    rangeDef = new raynna.game.npc.combatdata.RangedDefence(defence, defence, defence);
                    break;

                case MAGIC:
                    meleeDef = new raynna.game.npc.combatdata.MeleeDefence(defence, defence, defence);
                    magicDef = new raynna.game.npc.combatdata.MagicDefence(defence * 2);
                    rangeDef = new raynna.game.npc.combatdata.RangedDefence(defence / 2, defence / 2, defence / 2);
                    break;
                ...
                default:
                    meleeDef = new raynna.game.npc.combatdata.MeleeDefence(defence, defence, defence);
                    magicDef = new raynna.game.npc.combatdata.MagicDefence(defence);
                    rangeDef = new raynna.game.npc.combatdata.RangedDefence(defence, defence, defence);
                    break;
            }
            ...
            combatData = new CombatData(
                    ...
                    new raynna.game.npc.combatdata.Immunities(false, false, false, false, false),
                    new raynna.game.npc.combatdata.Weaknesses(),
                    new raynna.game.npc.combatdata.MaxHit(maxHit, maxHit, maxHit, maxHit),
        ...
        combatData = new CombatData(
                ...
                0, 0, 0,
                new raynna.game.npc.combatdata.MeleeDefence(defenceLevel * 2, defenceLevel * 2, defenceLevel * 2),
                new raynna.game.npc.combatdata.MagicDefence((int) (defenceLevel * 1.5)),
                new raynna.game.npc.combatdata.RangedDefence(defenceLevel * 2, defenceLevel * 2, defenceLevel * 2),
                new raynna.game.npc.combatdata.Immunities(false, false, false, false, false),
                new raynna.game.npc.combatdata.Weaknesses(),
                new raynna.game.npc.combatdata.MaxHit(maxHit, maxHit, maxHit, maxHit),
                true,
