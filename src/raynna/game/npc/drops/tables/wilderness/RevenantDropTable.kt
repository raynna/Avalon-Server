package raynna.game.npc.drops.tables.wilderness
    ...
    val table =
        dropTable(category = TableCategory.OTHER) {
            ...
            prerollDenom(meta = { collectionLog = true }) {
                ...
                ).forEach { drop(it, numerator = 1, denominator = 1500) { collectionLog = true } }
                listOf(
