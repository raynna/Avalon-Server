...
public final class EmotesManager implements Serializable {
	...
	public void useBookEmote(int id) {
		...
		if (id == 2) {// Yes
			...
			player.animate(new Animation(player.getAppearance().isMale() ? 15033 : 15034));
			...
			player.animate(new Animation(player.getAppearance().isMale() ? 15535 : 15536));
		} else if (id == 98) {// Golf Clap
			player.animate(new Animation(15520));
		} else if (id == 99) {// LOLcano
			player.animate(new Animation(player.getAppearance().isMale() ? 15532 : 15533));
			...
			player.animate(new Animation(player.getAppearance().isMale() ? 15526 : 15527));
			...
			player.animate(new Animation(player.getAppearance().isMale() ? 16373 : 16374));
			...
			player.animate(new Animation(player.getAppearance().isMale() ? 17212 : 17213));
 ...
 * 
 * import raynna.app.Settings; import raynna.core.cache.defintions.NPCDefinitions; import
 * raynna.game.Animation; import raynna.game.Graphics; import raynna.game.World;
 * import raynna.game.WorldTile; import raynna.game.npc.NPC; import
 * raynna.core.tasks.WorldTask; import raynna.core.tasks.WorldTasksManager;
 * import raynna.core.packets.decode.WorldPacketsDecoder; import raynna.util.Utils;
 * 
 * public final class EmotesManager implements Serializable {
 * 
 * private static final long serialVersionUID = 8489480378717534336L;
