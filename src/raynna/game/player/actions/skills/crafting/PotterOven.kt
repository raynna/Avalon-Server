package raynna.game.player.actions.skills.crafting
...
class PotterOven(
    ...
    enum class Products(
        ...
        POT(1, 6.3, Item(1787), Item(1931), 0),
        PIE_DISH(7, 10.0, Item(1789), Item(2313), 1),
        BOWL(8, 15.0, Item(1791), Item(1923), 2),
        ;
