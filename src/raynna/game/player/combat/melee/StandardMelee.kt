...
import raynna.game.player.combat.damage.CombatHitRoll
import raynna.game.player.combat.effects.AncientGodswordEffect
import raynna.game.player.combat.special.*
        ...
        listOf(
            ...
            MeleeWeapon(
                itemId =
                    Weapon.itemIds(
                        ...
                        "item.abyssal_whip_7",
                        "item.abyssal_whip_8",
                        "item.abyssal_vine_whip",
                        "item.abyssal_vine_whip_2",
                        "item.abyssal_vine_whip_3",
                        "item.abyssal_vine_whip_4",
                        "item.abyssal_vine_whip_5",
                        "item.abyssal_whip_osrs",
                        "item.abyssal_tentacle",
                    ),
                name = "Abyssal whip",
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        "item.dragon_dagger",
                        "item.dragon_dagger_p",
                        "item.dragon_dagger_p+",
                        "item.dragon_dagger_p++",
                        "item.infernal_dagger",
                    ),
                name = "Dragon dagger",
                    ...
                    SpecialAttack.Combat(
                        ...
                        execute = { context ->
                            ...
                            context
                                ...
                                .roll(CombatHitRoll.NORMAL)
                            context
                                .addHit(CombatType.MELEE)
                                .accuracy(1.15)
                                .damageMultiplier(1.15)
                                .delay(if (context.defender is NPC) 1 else 0)
                                .roll(CombatHitRoll.NORMAL)
                        },
                    ),
            ),
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        ...
                        "item.adamant_mace",
                        "item.rune_mace",
                        "item.void_knight_mace",
                        "item.tzhaar_ket_em",
                        "item.inquisitor_s_mace",
                    ),
                name = "Maces",
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        ...
                        "item.torag_s_hammers_100",
                        "item.torag_s_hammers_75",
                        "item.torag_s_hammers_50",
                        "item.torag_s_hammers_25",
                        "item.torag_s_hammers_0",
                    ),
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        ...
                        "item.steel_halberd",
                        "item.black_halberd",
                        "item.mithril_halberd",
                        "item.adamant_halberd",
                        "item.rune_halberd",
                        "item.noxious_halberd",
                    ),
                name = "Halberd",
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        ...
                        "item.bandos_godsword_2",
                        "item.lucky_bandos_godsword",
                    ),
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        ...
                        "item.dharok_s_greataxe_100",
                        "item.dharok_s_greataxe_75",
                        "item.dharok_s_greataxe_50",
                        "item.dharok_s_greataxe_25",
                        "item.dharok_s_greataxe_0",
                    ),
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        "item.bronze_scimitar",
                        "item.iron_scimitar",
                        "item.steel_scimitar",
                        "item.black_scimitar",
                        "item.mithril_scimitar",
                        "item.adamant_scimitar",
                        "item.rune_scimitar",
                        "item.corrupt_dragon_scimitar",
                        "item.c_dragon_scimitar_deg",
                        "item.sacred_clay_scimitar",
                    ),
                name = "Scimitar",
                weaponStyle = WeaponStyle.SCIMITAR,
                blockAnimationId = Animation.getId("animation.scimitar_block"),
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        ...
                        "item.adamant_dagger",
                        "item.rune_dagger",
                        "item.corrupt_dragon_dagger",
                        "item.c_dragon_dagger_deg",
                        "item.novite_dagger",
                        "item.novite_dagger_b",
                        "item.bathus_dagger",
                        "item.bathus_dagger_b",
                        "item.marmaros_dagger",
                        "item.marmaros_dagger_b",
                        "item.kratonite_dagger",
                        "item.kratonite_dagger_b",
                        "item.fractite_dagger",
                        "item.fractite_dagger_b",
                        "item.zephyrium_dagger",
                        "item.zephyrium_dagger_b",
                        "item.argonite_dagger",
                        "item.argonite_dagger_b",
                        "item.hailstorm_dagger",
                        "item.hailstorm_dagger_b",
                        "item.katagon_dagger",
                        "item.katagon_dagger_b",
                        "item.gorgonite_dagger",
                        "item.gorgonite_dagger_b",
                        "item.promethium_dagger",
                        "item.promethium_dagger_b",
                        "item.primal_dagger",
                        "item.primal_dagger_b",
                        "item.toktz_xil_ak",
                    ),
                name = "Dagger",
                weaponStyle = WeaponStyle.DAGGER,
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        "item.bronze_battleaxe",
                        "item.iron_battleaxe",
                        "item.steel_battleaxe",
                        "item.black_battleaxe",
                        "item.mithril_battleaxe",
                        "item.adamant_battleaxe",
                        "item.rune_battleaxe",
                        "item.corrupt_dragon_battleaxe",
                        "item.c_dragon_battleaxe_deg",
                        "item.novite_battleaxe",
                        "item.novite_battleaxe_b",
                        "item.bathus_battleaxe",
                        "item.bathus_battleaxe_b",
                        "item.marmaros_battleaxe",
                        "item.marmaros_battleaxe_b",
                        "item.kratonite_battleaxe",
                        "item.kratonite_battleaxe_b",
                        "item.fractite_battleaxe",
                        "item.fractite_battleaxe_b",
                        "item.zephyrium_battleaxe",
                        "item.zephyrium_battleaxe_b",
                        "item.argonite_battleaxe",
                        "item.argonite_battleaxe_b",
                        "item.katagon_battleaxe",
                        "item.katagon_battleaxe_b",
                        "item.gorgonite_battleaxe",
                        "item.gorgonite_battleaxe_b",
                        "item.promethium_battleaxe",
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        "item.bronze_warhammer",
                        "item.iron_warhammer",
                        "item.steel_warhammer",
                        "item.black_warhammer",
                        "item.mithril_warhammer",
                        "item.adamant_warhammer",
                        "item.rune_warhammer",
                        "item.corrupt_statius_s_warhammer",
                        "item.c_statius_s_warhammer_deg",
                        "item.novite_warhammer",
                        "item.novite_warhammer_b",
                        "item.bathus_warhammer",
                        "item.bathus_warhammer_b",
                        "item.marmaros_warhammer",
                        "item.marmaros_warhammer_b",
                        "item.kratonite_warhammer",
                        "item.kratonite_warhammer_b",
                        "item.fractite_warhammer",
                        "item.fractite_warhammer_b",
                        "item.zephyrium_warhammer",
                        "item.zephyrium_warhammer_b",
                        "item.argonite_warhammer",
                        "item.argonite_warhammer_b",
                        "item.katagon_warhammer",
                        "item.katagon_warhammer_b",
                        "item.gorgonite_warhammer",
                        "item.gorgonite_warhammer_b",
                        "item.promethium_warhammer",
                        "item.promethium_warhammer_b",
                        "item.primal_warhammer",
                        "item.primal_warhammer_b",
                    ),
                name = "Warhammer",
                weaponStyle = WeaponStyle.HAMMER,
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        ...
                        "item.statius_warhammer_deg",
                        "item.dragon_warhammer",
                    ),
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        ...
                        "item.novite_longsword",
                        "item.novite_longsword_b",
                        "item.bathus_longsword",
                        "item.bathus_longsword_b",
                        "item.marmaros_longsword",
                        "item.marmaros_longsword_b",
                        "item.kratonite_longsword",
                        "item.kratonite_longsword_b",
                        "item.fractite_longsword",
                        "item.fractite_longsword_b",
                        "item.zephyrium_longsword",
                        "item.zephyrium_longsword_b",
                        "item.argonite_longsword",
                        "item.argonite_longsword_b",
                        "item.katagon_longsword",
                        "item.katagon_longsword_b",
                        "item.gorgonite_longsword",
                        "item.gorgonite_longsword_b",
                        "item.promethium_longsword",
                        "item.promethium_longsword_b",
                        "item.primal_longsword",
                        "item.primal_longsword_b",
                        "item.silverlight",
                        "item.toktz_xil_ek",
                    ),
                name = "Longsword",
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        "item.viggora_s_chainmace",
                        "item.viggora_s_chainmace_u",
                        "item.verac_s_flail",
                        "item.verac_s_flail_100",
                        "item.verac_s_flail_75",
                        "item.verac_s_flail_50",
                        "item.verac_s_flail_25",
                        "item.verac_s_flail_0",
                    ),
                name = "Flail",
                weaponStyle = WeaponStyle.MACE,
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        "item.chaotic_rapier",
                        "item.chaotic_rapier_broken",
                        "item.brackish_blade",
                        "item.novite_rapier",
                        "item.novite_rapier_b",
                        "item.bathus_rapier",
                        "item.bathus_rapier_b",
                        "item.marmaros_rapier",
                        "item.marmaros_rapier_b",
                        "item.kratonite_rapier",
                        "item.kratonite_rapier_b",
                        "item.fractite_rapier",
                        "item.fractite_rapier_b",
                        "item.zephyrium_rapier",
                        "item.zephyrium_rapier_b",
                        "item.argonite_rapier",
                        "item.argonite_rapier_b",
                        "item.katagon_rapier",
                        "item.katagon_rapier_b",
                        "item.gorgonite_rapier",
                        "item.gorgonite_rapier_b",
                        "item.promethium_rapier",
                        "item.promethium_rapier_b",
                        "item.primal_rapier",
                        "item.primal_rapier_b",
                    ),
                name = "Rapier",
            ...
            MeleeWeapon(
                ...
                animations =
                    mapOf(
                        ...
                        StyleKey(AttackStyle.DEFENSIVE, 2) to Animation.getId("animation.tzhaar_tok_om_attack"),
                    ),
            ),
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        "item.chaotic_maul",
                        "item.chaotic_maul_broken",
                        "item.novite_maul",
                        "item.novite_maul_b",
                        "item.bathus_maul",
                        "item.bathus_maul_b",
                        "item.marmaros_maul",
                        "item.marmaros_maul_b",
                        "item.kratonite_maul",
                        "item.kratonite_maul_b",
                        "item.fractite_maul",
                        "item.fractite_maul_b",
                        "item.zephyrium_maul",
                        "item.zephyrium_maul_b",
                        "item.argonite_maul",
                        "item.argonite_maul_b",
                        "item.katagon_maul",
                        "item.katagon_maul_b",
                        "item.gorgonite_maul",
                        "item.gorgonite_maul_b",
                        "item.promethium_maul",
                        "item.promethium_maul_b",
                        "item.primal_maul",
                        "item.primal_maul_b",
                        "item.elder_maul",
                    ),
            ...
            MeleeWeapon(
                itemId =
                    Item.getIds(
                        "item.bronze_2h_sword",
                        "item.iron_2h_sword",
                        "item.steel_2h_sword",
                        "item.black_2h_sword",
                        "item.mithril_2h_sword",
                        "item.adamant_2h_sword",
                        "item.rune_2h_sword",
                        "item.white_2h_sword",
                        "item.novite_2h_sword",
                        "item.novite_2h_sword_b",
                        "item.bathus_2h_sword",
                        "item.bathus_2h_sword_b",
                        "item.marmaros_2h_sword",
                        "item.marmaros_2h_sword_b",
                        "item.kratonite_2h_sword",
                        "item.kratonite_2h_sword_b",
                        "item.fractite_2h_sword",
                        "item.fractite_2h_sword_b",
                        "item.zephyrium_2h_sword",
                        "item.zephyrium_2h_sword_b",
                        "item.argonite_2h_sword",
                        "item.argonite_2h_sword_b",
                        "item.katagon_2h_sword",
                        "item.katagon_2h_sword_b",
                        "item.gorgonite_2h_sword",
                        "item.gorgonite_2h_sword_b",
                        "item.promethium_2h_sword",
                        "item.promethium_2h_sword_b",
                        "item.primal_2h_sword",
                        "item.primal_2h_sword_b",
                    ),
                name = "2h sword",
                weaponStyle = WeaponStyle.TWO_HANDED_SWORD,
                blockAnimationId = Animation.getId("animation.two_handed_defend"),
                    ...
                    SpecialAttack.Combat(
                        ...
                        execute = { context ->
                            ...
                            for (target in targets) {
                                context
                                    .addHit(CombatType.MELEE, target)
                                    .delay(1)
                                    .accuracy(1.15)
                                    .damageMultiplier(1.1)
                                    .roll()
