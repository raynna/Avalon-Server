...
import raynna.game.player.combat.special.procHit
        ...
        SpecialEffect(
            execute = { context ->
                ...
                if (!Utils.roll(rawChance + extraChance, 100) && !guaranteed) {
                    return@SpecialEffect EffectResult.CONTINUE
                }
            ...
            execute = { context ->
                ...
                val hit =
                    context
                        ...
                        .roll()
                if (hit.damage == 0) return@SpecialEffect EffectResult.CONTINUE
    ...
    val DRAGONSTONE =
        SpecialEffect(
            execute = { context ->
                ...
                val boost =
                    if (context.weaponId == Item.getId("item.zaryte_crossbow")) {
                        0.22
                    } else {
                        0.20
                    }
                ...
                val hit =
                    context.addHit(CombatType.RANGED).delay(projectileDelay).roll().apply {
                        if (damage > 0) {
            ...
            execute = { context ->
                ...
                val boltHit =
                    context
                        ...
                        .delay(projectileDelay)
                        .roll()
                if (boltHit.damage == 0) return@SpecialEffect EffectResult.CONTINUE
