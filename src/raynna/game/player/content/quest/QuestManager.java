...
import raynna.game.player.content.quest.State.QuestState;
import raynna.game.player.content.quest.impl.cooksassistant.CooksAssistant;
import raynna.game.player.content.quest.impl.demonslayer.DemonSlayer;
import raynna.game.player.content.quest.impl.doricsquest.DoricsQuest;
import raynna.game.player.content.quest.impl.druidicritual.DruidicRitual;
import raynna.game.player.content.quest.impl.goblindiplomacy.GoblinDiplomacy;
import raynna.game.player.content.quest.impl.gunnarsground.GunnarsGround;
import raynna.game.player.content.quest.impl.impcatcher.ImpCatcher;
import raynna.game.player.content.quest.impl.piratestreasure.PiratesTreasure;
import raynna.game.player.content.quest.impl.piratestreasure.interfaces.Scroll;
import raynna.game.player.content.quest.impl.princealirescue.PrinceAliRescue;
import raynna.game.player.content.quest.impl.restlessghost.RestlessGhost;
import raynna.game.player.content.quest.impl.runemysteries.RuneMysteries;
import raynna.game.player.content.quest.impl.vampireslayer.VampireSlayer;
