...
import raynna.game.npc.others.BarrowsBrother;
...
public final class Barrows extends Controller {
    ...
    private static final Item[] COMMON_REWARDS = {
            new Item(ItemId.MIND_RUNE, Utils.random(850)),
            new Item(ItemId.CHAOS_RUNE, Utils.random(850)),
            new Item(ItemId.DEATH_RUNE, Utils.random(600)),
            new Item(ItemId.BLOOD_RUNE, Utils.random(850)),
            new Item(ItemId.BOLT_RACK_4740, Utils.random(850))};
...
//			player.getPackets().sendIComponentAnimation(9810, 24, headComponentId);
            ...
            if (activeLevel > 0) {
                int level = player.getSkills().getRealLevel(Skills.PRAYER) * 10;
