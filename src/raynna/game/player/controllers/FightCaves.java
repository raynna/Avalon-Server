...
import raynna.game.npc.fightcaves.FightCavesNPC;
import raynna.game.npc.fightcaves.TzKekCaves;
import raynna.game.npc.fightcaves.TzTok_Jad;
            ...
            if (type == 1 || type == 4) {
                ...
                if (type == 4) {
                    ...
                    if (player.getInventory().hasFreeSlots()) {
                        ...
                        GroundItems.addGroundItem(new Item(6529, tokkul), player.getLastWorldTile(), player, true, 60);
