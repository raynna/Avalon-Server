package raynna.game.player.controllers.construction;
...
import raynna.game.player.actions.skills.construction.impl.ConveyorBeltHopper;
import raynna.game.player.actions.skills.construction.impl.CutPlank;
import raynna.game.player.actions.skills.construction.impl.PlanksTake;
import raynna.game.player.actions.skills.construction.impl.StackOfLogs;
...
public class SawmillController extends Controller {
	...
	public boolean processObjectClick1(final WorldObject object) {
		...
		case 46317:
			...
			player.lock(2);
			player.getInventory().addItem(ItemId.SAW_8794, 1);
