...
import raynna.game.Keys;
import raynna.game.player.VariableKeys;
...
public class Giles extends Dialogue {
	...
	@Override
	public void start() {
		if (!player.get(Keys.BooleanKey.TALKED_TO_GILES)) {
	...
	public void run(int interfaceId, int componentId) {
		...
		case 5:
			...
			player.set(Keys.BooleanKey.TALKED_TO_GILES, true);
			stage = 6;
			break;
		case 6:
			switch (componentId) {
