package raynna.game.player.dialogues.npcs;
    ...
    public void run(int interfaceId, int componentId) {
        switch (stage) {
            case -1:
                ...
                break;
            case 1:
                sendOptionsDialogue("CHOOSE AN OPTION:", "Do you have anything for sale?", "Can i claim my untradeables?", "Who are you?", "Oh, sorry, I thought you were someone else.");
                stage = 2;
                break;
            case 2:
                switch (componentId) {
                    case OPTION_1:
                        ...
                        break;
                    case OPTION_2:
                        if (player.getUntradeables().getContainerItems().length == 0) {
                            sendNPCDialogue(Mandrith, Thinking, "It seems like you haven't lost any untradeables.");
                            end();
                            break;
                        }
                        sendNPCDialogue(Mandrith, Happy, "Yes, here is what you've lost.");
                        stage = 31;
                        break;
                    case OPTION_3:
