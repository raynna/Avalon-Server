...
import raynna.game.world.activity.pvpgame.lms.LastManStandingLobby
import raynna.game.world.activity.pvpgame.tournament.TournamentLobby
...
fun Player.openPvPOverlay(player: Player, target: Player) {
    ...
    packets.sendTextOnComponent(265, 10, target.displayName)
}
